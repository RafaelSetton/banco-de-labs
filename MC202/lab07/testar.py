...
class Task(BaseTask):
    ...
    def teste_medios(self):
        global binary
        binary = self.generate_binary(binary=binary)
        self.test_cases(binary, self.case_range("teste{}.in", 8, 11))

    def teste_grandes(self):
        global binary
        binary = self.generate_binary(binary=binary)
        self.test_cases(binary, self.case_range("teste{}.in", 12, 15))
